//http://underscorejs.org v1.7.0 | (c) 2009-2014 Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors | MIT license
...
// JSO Quiz | Version 1.1.0 | Michael Andre
var createQuiz = function(quizData) {
  ...
  function showResults() {
    ...
    var data = {correct: correct, total: questions.length, url: window.location.origin + window.location.pathname};
    wrap.innerHTML = JST.generateResults(data);
    var cores = wrap.children;
  ...
  try {
    ...
    //prev/next btns
    quiz.innerHTML = quiz.innerHTML + JST.generateFooter({first: 1, total: questions.length});
...
with (obj) {
__p += '<div class="q-quiz-footer">\n  <button id="q-next-question" class="q-quiz-button"><span class="q-lg">Next question</span><span class="q-sm">&gt;</span></button>\n  <button id="q-quiz-results" class="q-quiz-button">Results</button>\n  <div class="q-progress">\n    <span id="q-number">' +
((__t = ( first )) == null ? '' : __t) +
'</span>\n    of\n    <span id="q-total">' +
((__t = ( total )) == null ? '' : __t) +
'</span>\n  </div>\n  <button id="q-previous-question" class="q-quiz-button"><span class="q-sm">&lt;</span><span class="q-lg">Previous question</span></button>\n</div>\n';
